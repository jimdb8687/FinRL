...
test_returns, baseline_returns = get_returns(df_account_value_ppo, baseline_start=config.TRADE_START_DATE,
                                             baseline_end=config.TRADE_END_DATE,
                                             baseline_ticker="^DJI",
                                             value_col_name="account_value")
matplotlib.use('Agg')
...
test_returns, baseline_returns = get_returns(df_account_value_ddpg, baseline_start=config.TRADE_START_DATE,
                                             baseline_end=config.TRADE_END_DATE,
                                             baseline_ticker="^DJI",
                                             value_col_name="account_value")
...
# In[ ]:
test_returns, baseline_returns = get_returns(df_account_value_a2c, baseline_start=config.TRADE_START_DATE,
                                             baseline_end=config.TRADE_END_DATE,
                                             baseline_ticker="^DJI",
                                             value_col_name="account_value")
...
# In[ ]:
test_returns, baseline_returns = get_returns(df_account_value_sac, baseline_start=config.TRADE_START_DATE,
                                             baseline_end=config.TRADE_END_DATE,
                                             baseline_ticker="^DJI",
                                             value_col_name="account_value")
...
# %%
test_returns, baseline_returns = get_returns(df_account_value_td3, baseline_start=config.TRADE_START_DATE,
                                             baseline_end=config.TRADE_END_DATE,
                                             baseline_ticker="^DJI",
                                             value_col_name="account_value")
